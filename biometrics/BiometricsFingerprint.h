...
using IBiometricsFingerprint_2_3 = ::android::hardware::biometrics::fingerprint::V2_3::IBiometricsFingerprint;
...
struct BiometricsFingerprint : public IBiometricsFingerprint {
    ...
    // Methods from ::V2_3::IBiometricsFingerprint follow.
...
private:
    sp<IBiometricsFingerprint_2_3> biometrics_2_3_service;
